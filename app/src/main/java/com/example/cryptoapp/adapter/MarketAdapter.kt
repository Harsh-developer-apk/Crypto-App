...
import com.example.cryptoapp.fragments.MarketFragmentDirections
import com.example.cryptoapp.fragments.WatchListFragment
import com.example.cryptoapp.fragments.WatchListFragmentDirections
import com.example.cryptoapp.models.CryptoCurrency

class MarketAdapter(val context: Context, var list: List<CryptoCurrency>, var type: String): RecyclerView.Adapter<MarketAdapter.MarketViewHolder>(){
